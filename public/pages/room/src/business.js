class Business {
  ...
  onPeerStreamReceived() {
    return (call, stream ) => {
      ...
      if(this.peers.has(callerId)) {
        console.log('Calling twicem ignoring second call...', callerId);
        return
      }
  ...
  onPeerCallError() {
    return (call, error) => {
      console.log('call error ocurred', error)
  ...
  // se user entrar e sair da call durante a gravação -> para gravações anteriores dele
